...
<body>
	...
	<table>
		...
		onclick="location.href='${ctx}/rentcar/Main.jsp';
		<%session.setAttribute("cmenu", "center.jsp");%>">
		<img src="/RentCar_Project/rentcar/image/rent_logo.jpg" height="100">
		</p></td>
		<td width="200"></td>
	...
	<header>
        ...
        <%--  <%session.setAttribute("cmenu", "${ctx}/carReserveMain.do");%>;  --%>         				
