...
select * from member;
insert into member(id,pw,name,email,gender,hobby) values('admin','admin','admin','admin@test.com','남성','놀기');
...
insert into member(id,pw,name,email,gender,hobby) values('test5','4444','테스트4','test4@test.com','남성','축구');

delete from member where id="eraer";
select * from board;
